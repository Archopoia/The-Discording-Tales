...
const UI = {
  fr: {
    ...
    createDiceTooltip: (n: number) => `Répartissez exactement ${n} dés dans les compétences révélées (Exprimés), puis lancez.`,
    validate: 'Valider',
  ...
  en: {
    ...
    createDiceTooltip: (n: number) => `Distribute exactly ${n} dice across revealed competences (Exprimés), then launch.`,
    validate: 'Validate',
