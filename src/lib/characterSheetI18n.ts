...
const UI = {
  fr: {
    ...
    createAttrTooltip: "Base Peuple déjà appliquée. Ajoutez l'individuation : +2, +1, 0, 0, 0, 0, -1, -2 (une par attribut).",
    createAttrSpreadTooltip: "Base Peuple + individuation (+2, +1, 0, 0, 0, 0, -1, -2) par attribut.",
    createRevealTooltip: 'Choisissez de 3 à 5 compétences à révéler en cliquant sur « Révéler … ? » sur la feuille.',
    createDiceTooltip: (n: number) => `Répartissez exactement ${n} dés dans les compétences révélées et/ou les résistances R[…], puis lancez.`,
    validate: 'Valider',
    random: 'Aléatoire',
    ...
    createOriginTooltip: "Choisissez l'origine de votre personnage (ou utilisez le chat).",
    createPeupleTooltip: 'Choisissez le peuple (ou utilisez le chat).',
    createNameTooltip: 'Entrez le nom de votre personnage (optionnel).',
  ...
  en: {
    ...
    createAttrTooltip: 'People base already applied. Add individuation: +2, +1, 0, 0, 0, 0, -1, -2 (one per attribute).',
    createAttrSpreadTooltip: 'People base + individuation (+2, +1, 0, 0, 0, 0, -1, -2) per attribute.',
    createRevealTooltip: 'Choose 3 to 5 skills to reveal by clicking "Reveal …?" on the sheet.',
    createDiceTooltip: (n: number) => `Distribute exactly ${n} dice across revealed competences and/or resistances R[…], then launch.`,
    validate: 'Validate',
    random: 'Random',
    ...
    createOriginTooltip: 'Choose your character\'s origin (or use the chat).',
    createPeupleTooltip: 'Choose your people (or use the chat).',
    createNameTooltip: 'Enter your character\'s name (optional).',
    chooseOrigin: 'Origin',
    choosePeuple: 'People',
    characterNameLabel: 'Character name',
    narrativeInChatHint: 'Set origin, people, and name in the chat above.',
    nextStep: 'Next',
