...
const UI = {
  fr: {
    ...
    createAttrTooltip: 'Assignez exactement une valeur par attribut : +2, +1, 0, 0, 0, 0, -1, -2 (total = 0).',
    createAttrSpreadTooltip: 'Assignez +2, +1, 0, 0, 0, 0, -1, -2 (une valeur par attribut). Total = 0.',
  ...
  en: {
    ...
    createAttrTooltip: 'Assign exactly one value per attribute: +2, +1, 0, 0, 0, 0, -1, -2 (sum = 0).',
    createAttrSpreadTooltip: 'Assign +2, +1, 0, 0, 0, 0, -1, -2 (one per attribute). Sum = 0.',
