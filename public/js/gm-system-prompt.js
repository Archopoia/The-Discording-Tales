...
(function () {
    ...
    var GM_CREATION_PROMPT = [
        ...
        '',
        'Steps: 1. Origine: [Choice id=origine] with [Option Yômmes], [Option Yôrres], [Option Bêstres]. 2. Peuple: [Choice id=peuple] with options by Origine (Yômmes: Aristese, Greyscribes, Navillis, Meridians; Yôrres: Great Ylves, Pale Ylves, Lake Ylves, Iqqars; Bêstres: Slaadeans, Tchalkchaïs). 3. [Input id=name] for name. 4. Attributes: +2,+1,0,0,0,0,-1,-2 for FOR,AGI,DEX,VIG,EMP,PER,CRE,VOL (sum=0). 5. Reveal 3–5 competences. 6. Assign 10 dice. 7. [Complete] [StateJSON].',
        '',
    ...
    var LORE_SUMMARY = [
        '**World (Iäoduneï):** Cytocosmism: concave universe, infinite continuity. Cords braided from two strands (Éo, oÀ); Rils as knots in the cord of ÉoÀ. Ô (World), WÔM (Time), HISM (Forces). Four Tetrarchs: iôHôi (Whirling), sôIôs (Tension), môSôm (Alignment), hôMôh (Torsion). 10 Peoples across 3 Origins: Yômmes (Aristese, Greyscribes, Navillis, Meridians), Yôrres (Great Ylves, Pale Ylves, Lake Ylves, Iqqars), Bêstres (Slaadeans, Tchalkchaïs). Each has distinct moralities, physiologies, and traits. Setting tone: extreme territories, exaggerated creatures, eccentric societies, techno-traditionalism, animatheist religiosities. Perspectivism: no absolute good/evil; moralities are cultural.',
